...
public class MainActivity extends Activity
{
   ...
   public void initEngine(String parmPath) throws Exception
   {
      ...
      mIp.SetLicense("JFDZPR4HW9HBFL98NB42YNWK7BJHHAYV7MYYWNLMMHAG27HYLTWQWJZ5B3KJ7A9WUN8AW3CUHJTEFDXJP4TJHSX8C42QXEH7V8BZRPPHBFYQDCZJLRZTA4TMGT4P55KL4ZT72ZEMPRY27XWTBSC9MDKMDC"); // To be provided by A2iA before starting the program.
   }
